...
- `rag/` ingests documents, computes embeddings, and implements semantic,
  BM25, hybrid, and TypeScript-native HippoRAG2 retrieval used by the search tool.
...
the search route and search tool both resolve retrieval through the shared registry.
